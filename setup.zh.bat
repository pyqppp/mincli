...
pip install tiktoken typer "python-dotenv>=1.0.0" "openai>=1.0.0" rich prompt-toolkit pdfminer.six python-docx trafilatura -i https://pypi.tuna.tsinghua.edu.cn/simple --trusted-host pypi.tuna.tsinghua.edu.cn
